    ...
    return (
        <div name='home' className={nav ? 'navbar navbar-bg' : 'navbar'}>
            ...
            <ul className="nav-menu">
                ...
                <Link to='carousel' smooth={true} duration={500} ><li>Galeria</li></Link>
                <Link to='search' smooth={true} duration={500} ><li>Planes</li></Link>
                <Link to='views' smooth={true} duration={500} ><li>Favoritos</li></Link>
            </ul>
